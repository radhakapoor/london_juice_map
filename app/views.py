...
by_id = {1:{'neighbourhood_url':'soho' , 'neighbourhood_name':'Soho', 'lat': 51.512845, 'lng':-0.134020, 'zoom': 16, 'bars':[('The Juice Well','4 Peter Street, Soho, London W1F 0DN', '+44 20 7439 9399','', 1), ('Juice Tonic Organic Juicery', '3 Winnett Street, Soho, London W1D 6JY', '+44 20 7434 3706'),('MOJO Juice Bar & Cafe','8 D\'Arblay Street, W1F 8DP', '+44 20 8001 6520'), ('Press', '6 Denman Street, Ham Yard Hotel, London W1D 7HD', '')] }, 
			2:{'neighbourhood_url': 'nottinghill' , 'neighbourhood_name': 'Notting Hill', 'lat': 51.515095, 'lng': -0.201228, 'zoom': 15, 'bars':[('Raw Press at Wolf & Badger Notting Hill','Wolf & Badger, 46 Ledbury Road, London W11 2AB', ''), ('Elixir Juicery','Urban Bliss, 333 Portobello Road, Notting Hill, London W10 5SA',''), ('Planet Organic','42 Westbourne Grove, London W2 5SH', '+44 20 7727 2227','')] },
			3:{'neighbourhood_url': 'mayfair' , 'neighbourhood_name': 'Mayfair', 'lat': 51.512413, 'lng': -0.145555, 'zoom': 16, 'bars':[('Imbibery London at Mount Street Deli','100 Mount Street, W1K 2TG', '+44 20 7499 6843'), ('Raw Press at Wolf & Badger Mayfair', '32 Dover Street, London, W1S 4NE', '', '')] },
			4:{'neighbourhood_url': 'marylebone' , 'neighbourhood_name': 'Marylebone', 'lat': 51.517697, 'lng': -0.151675, 'zoom': 16, 'bars':[('Roots and Bulbs','5 Thayer Street, Marylebone, London W1U 3JG', '')] },
			5:{'neighbourhood_url': 'camden' , 'neighbourhood_name': 'Camden', 'lat': 51.5410, 'lng': -0.1433, 'zoom': 15, 'bars':[('Goldies Fresh Projuice','The Fitness Mosaic, 81-84 Chalk Farm Road, London, NW1 8AR')] },
			6:{'neighbourhood_url': 'chelsea' , 'neighbourhood_name': 'Chelsea', 'lat': 51.485120, 'lng': -0.174707, 'zoom': 15, 'bars':[('The Good Life Eatery','59 Sloane Avenue London SW3 3DH','+44 20 7052 9388'), ('Imbibery London at The Box Boutique','104 Draycott Avenue, SW3 3AE', '')] },
			7:{'neighbourhood_url': 'westend' , 'neighbourhood_name': 'West End', 'lat': 51.514310, 'lng': -0.149700, 'zoom': 16, 'bars':[('Juice Club at Selfridges','400 Oxford Street, London W1A 1AB')] },
			8:{'neighbourhood_url': 'towerbridge' , 'neighbourhood_name': 'Tower Bridge', 'lat': 51.504185, 'lng': -0.076322, 'zoom': 15, 'bars':[('Juice Club at Maltby Street Food Market, Maltby Street, London SE1 3PA', '', '', '')] },
			9:{'neighbourhood_url': 'shoreditch' , 'neighbourhood_name': 'Shoreditch', 'lat': 51.523447, 'lng': -0.077107, 'zoom': 16, 'bars': [('Lovage','100 Shoreditch High Street, London EC 6JQ')] },
			10:{'neighbourhood_url': 'coventgarden' , 'neighbourhood_name': 'Covent Garden', 'lat': 51.513180, 'lng': -0.121726, 'zoom': 16, 'bars':[('Lab Organic','58 Neal Street, Covent Garden, London WC2H 9PA'),('Blend & Press','16a Neal\'s Yard, Covent Garden, London WC2H 9DP', '+44 20 3119 5966')] }
		}
by_name = {1:{'name_url': 'juicetonic', 'name': 'Juice Tonic', 'address': 'Soho', 'phone_number': '+44 207 439 9399', 'instagram_tag': 'juicetonic'}, 
			...
			4:{'name_url': 'rootsandbulbs', 'name': 'Roots and Bulbs', 'address': 'Soho2', 'phone_number': '+44 207 434 3706', 'instagram_tag': 'rootsandbulbs'},
...
def neighbourhood(id, neighbourhood):	
	...
	longitude = j['lng']	
	zoom = j['zoom']		
	return render_template("neighbourhood.html", juicebars = json.dumps(juicebars), lat=json.dumps(latitude), lng=json.dumps(longitude), zoom=json.dumps(zoom), neighbourhood_name=j['neighbourhood_name'], neighbourhood_bars=j['bars'])
